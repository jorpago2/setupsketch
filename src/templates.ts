...
export const setupTemplates: SetupTemplate[] = [
  {
    ...
    elements: [
      ...
      { id: "pd1", kind: "detector", label: "PD1", x: 1010, y: 350 },
      { id: "pd2", kind: "detector", label: "PD2", x: 790, y: 100, rotation: 90 },
    ],
    connections: [
      ...
      { from: "bs1", to: "m2", portType: "optical-free-space", fromPort: "bottom", toPort: "left" },
      { from: "m1", to: "bs2", portType: "optical-free-space", fromPort: "top", toPort: "left" },
      { from: "m2", to: "bs2", portType: "optical-free-space", fromPort: "right", toPort: "bottom" },
  ...
  },
  {
    ...
    elements: [
      ...
      { id: "delay", kind: "mirror", label: "Delay mirror", x: 540, y: 210, rotation: 45 },
  ...
  },
  {
    ...
    elements: [
      ...
      { id: "detector", kind: "detector", label: "Transmission", x: 350, y: 100, rotation: 90 },
    ],
    connections: [
      { from: "laser", to: "input", portType: "optical-free-space", fromPort: "right", toPort: "left" },
      { from: "input", to: "m1", portType: "optical-free-space", fromPort: "right", toPort: "bottom" },
      { from: "m1", to: "sample", portType: "optical-free-space", fromPort: "top", toPort: "top" },
      { from: "sample", to: "m2", portType: "optical-free-space", fromPort: "bottom", toPort: "top" },
      { from: "m2", to: "input", portType: "optical-free-space", fromPort: "bottom", toPort: "bottom" },
      { from: "input", to: "detector", portType: "optical-free-space", fromPort: "top", toPort: "left" },
    ],
  },
  {
    id: "lock-in",
    ...
    elements: [
      ...
      { id: "source", kind: "source", label: "Reference", x: 350, y: 620, rotation: -90 },
      { id: "splitter", kind: "splitter", label: "RF splitter", x: 350, y: 480, rotation: -90 },
    ...
    connections: [
      ...
      { from: "splitter", to: "mixer", portType: "rf", fromPort: "right-bottom", toPort: "left", waypoints: [{ x: 372, y: 500 }] },
      { from: "pd", to: "mixer", portType: "rf", fromPort: "right", toPort: "top", waypoints: [{ x: 868, y: 400 }, { x: 810, y: 400 }] },
  ...
  },
  {
    ...
    elements: [
      ...
      { id: "meter", kind: "rfpowermeter", label: "Power meter", x: 650, y: 550, rotation: -90 },
      { id: "termination", kind: "termination", label: "50 Ω", x: 490, y: 550, rotation: -90 },
    ],
    connections: [
      ...
      { from: "coupler", to: "meter", portType: "rf", fromPort: "right-bottom", toPort: "input" },
      { from: "coupler", to: "termination", portType: "rf", fromPort: "left-bottom", toPort: "input" },
      { from: "attenuator", to: "vna", portType: "rf", fromPort: "right", toPort: "input" },
    ],
  },
];
